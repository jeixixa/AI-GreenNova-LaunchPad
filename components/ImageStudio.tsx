                    ...
                    <div className="space-y-4">
                        <div className="relative group">
                            ...
                            <textarea
                                ...
                                className="w-full p-3 pr-10 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-sm focus:ring-2 focus:ring-brand-500 outline-none dark:text-white h-24 resize-none"
                            />
                            <div className="absolute right-2 bottom-2">
                                <VoiceInput onTranscript={(text) => setGeneratePrompt(prev => prev ? prev + ' ' + text : text)} className="w-8 h-8" />
                            </div>
                        </div>
                        ...
                        {showOverlayInput && (
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full p-3 pr-10 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-sm focus:ring-2 focus:ring-brand-500 outline-none dark:text-white mb-2"
                                />
                                <div className="absolute right-2 top-2">
                                    <VoiceInput onTranscript={(text) => setOverlayText(prev => prev ? prev + ' ' + text : text)} className="w-8 h-8" />
                                </div>
                                <select 
                                    value={selectedTheme} 
                ...
                {(mode === 'edit' || mode === 'animate') && (
                    <div className="space-y-4">
                        ...
                        <div className="relative group">
                            ...
                            />
                            <div className="absolute right-2 bottom-2">
                                <VoiceInput onTranscript={(text) => setEditPrompt(prev => prev ? prev + ' ' + text : text)} className="w-8 h-8" />
                            </div>
                        </div>
                    </div>
                )}
